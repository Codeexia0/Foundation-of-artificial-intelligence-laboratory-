...
# before we start, we need to define the knowledge base
knowledgebase = And(
    Or(AKnight, AKnave),
...
# B says nothing.
# If A is a knight, then the statement must be false, which is a contradiction.
# Therefore, A cannot be a knight.
# Hence, A must be a knave. Since B says nothing, B can be either a knight or a knave.
knowledge1 = And(
    # TODO
    knowledgebase,
